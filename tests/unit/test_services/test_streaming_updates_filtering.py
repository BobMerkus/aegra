...
class TestUpdatesFiltering:
    ...
    def test_process_interrupt_updates_2_tuple_with_interrupt(self):
        ...
        processed, should_skip = self.service._process_interrupt_updates(raw_event, only_interrupt_updates=True)
    ...
    def test_process_interrupt_updates_not_only_interrupt_mode(self):
        ...
        raw_event = ("updates", {"node": "test", "data": "value"})
        processed, should_skip = self.service._process_interrupt_updates(raw_event, only_interrupt_updates=False)
