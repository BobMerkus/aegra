...
| Streaming (8 SSE modes) | Supported | values, messages, messages-tuple, updates, events, custom, debug, and full modes. |
...
| Stateless runs | Coming soon | Execute without persisting state. Active development branch. |
