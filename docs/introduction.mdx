...
<Tip>
  **Using an AI coding tool?** Copy the prompt below to add the Aegra [skill](https://mintlify.com/docs/ai/skills) and [MCP server](https://mintlify.com/docs/ai/model-context-protocol) for better results when building with Aegra.
</Tip>
