...
*Comparing against the LangSmith Deployments SaaS offering (Plus plan). Deployments are not available on the free Developer plan. An enterprise tier with self-hosting is also available at custom pricing. See [LangChain pricing](https://www.langchain.com/pricing) for all plans.*

| | LangSmith Deployments (Plus) | Aegra |
|:--|:--|:--|
| **Seats** | \$39/seat/month | Free, unlimited |
| **Included deployments** | 1 free dev-sized (unlimited runs) | Unlimited |
| **Additional deployment runs** | \$0.005/run | \$0 |
| **Deployment uptime** | \$0.0007/min (dev), \$0.0036/min (prod) | \$0 |
| **Traces** | LangSmith (10k/mo included, then \$2.50/1k) | Any OTLP backend, no limits |
| **Self-hosted** | Enterprise only (custom pricing) | Always (Apache 2.0) |
| **Infrastructure** | Managed cloud | Your Postgres + compute |
