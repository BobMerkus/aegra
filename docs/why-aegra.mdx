...
|:--|:--|:--|
| **Free tier** | 1 seat, 50 runs/mo | Unlimited |
| **Paid seats** | $39/seat/month (Plus) | $0 |
| **Run cost** | $0.005/run | $0 |
| **Uptime cost** | $0.0007–$0.0036/min | $0 |
| **Traces** | LangSmith (5k–10k/mo included, then $2.50/1k) | Any OTLP backend, no limits |
| **Self-hosted option** | Enterprise tier only (custom pricing) | Always self-hosted (Apache 2.0) |
