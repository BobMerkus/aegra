...
|:--|:--|:--|
| **Seat cost** | $39/seat/month | $0 |
| **Run cost** | $0.005/run | $0 |
| **Node execution** | $0.001/node + $0.0036/min | $0 |
| **Traces** | Included (LangSmith only) | Your choice (OTLP fan-out) |
| **Infrastructure** | Managed | Your Postgres + compute |
| **Data residency** | Provider-controlled | Your infrastructure |
